...
\author{姓名}
\title{ECNU Beamer Theme}
\subtitle{毕业设计开题报告}
\institute{华东师范大学信息学部}
\date{\today}
\usepackage{ecnu}
...
\begin{frame}{为什么使用Beamer}
    \begin{itemize}[<+-| alert@+>] % 除使用alert，也可手动插入 \pause
        ...
        \item GitHub项目地址位于 \url{https://github.com/william-ecnu/ECNU-Beamer-Theme}
    \end{itemize}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/ECNU_Logo.png}
        \caption{校徽}
    \end{figure}
\end{frame}
